define(["require", "exports", "tslib", "react", "../../Utilities", "../../FocusZone", "../../Button", "../../Icon", "./Nav.styles"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, Button_1, Icon_1, Nav_styles_1) {
    ...
    var NavBase = /** @class */ (function (_super) {
        ...
        NavBase.prototype._renderNavLink = function (link, linkIndex, nestingLevel) {
            ...
            return (React.createElement(LinkAs, { className: classNames.link, styles: Nav_styles_1.buttonStyles, href: link.url || (link.forceAnchor ? 'javascript:' : undefined), iconProps: link.iconProps || { iconName: link.icon || '' }, onClick: link.onClick ? this._onNavButtonLinkClicked.bind(this, link) : this._onNavAnchorLinkClicked.bind(this, link), title: link.title || link.name, target: link.target, rel: rel, "aria-label": link.ariaLabel }, onRenderLink(link, this._onRenderLink)));
        };
