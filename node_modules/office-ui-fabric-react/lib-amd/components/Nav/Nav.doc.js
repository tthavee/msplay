define(["require", "exports", "react", "./examples/Nav.Basic.Example", "./examples/Nav.FabricDemoApp.Example", "./examples/Nav.Nested.Example", "./examples/Nav.ByKeys.Example", "./Nav.checklist", "office-ui-fabric-react/lib/components/Nav/examples/Nav.CustomGroupHeaders.Example"], function (require, exports, React, Nav_Basic_Example_1, Nav_FabricDemoApp_Example_1, Nav_Nested_Example_1, Nav_ByKeys_Example_1, Nav_checklist_1, Nav_CustomGroupHeaders_Example_1) {
    "use strict";
