define(["require", "exports", "react", "./examples/Dropdown.Basic.Example", "./examples/Dropdown.Custom.Example", "./examples/Dropdown.Error.Example", "./Dropdown.checklist"], function (require, exports, React, Dropdown_Basic_Example_1, Dropdown_Custom_Example_1, Dropdown_Error_Example_1, Dropdown_checklist_1) {
    "use strict";
    ...
    var DropdownBasicExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Dropdown/Dropdown.Basic.Example.Codepen.txt');
    ...
    exports.DropdownPageProps = {
        ...
        componentStatus: Dropdown_checklist_1.DropdownStatus,
        examples: [
            {
                title: 'Dropdown',
