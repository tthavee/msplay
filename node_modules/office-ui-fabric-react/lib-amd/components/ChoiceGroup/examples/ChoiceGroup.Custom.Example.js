                ...
                React.createElement(ChoiceGroup_1.ChoiceGroup, { defaultSelectedKey: "B", options: [
                        {
                            ...
                            onRenderField: function (props, render) {
                                return (React.createElement("div", { className: Utilities_1.css(styles.root) },
                                    render(props),
                                    React.createElement(Dropdown_1.Dropdown, { className: Utilities_1.css(styles.dropdown), defaultSelectedKey: "A", options: [{ key: 'A', text: '5 seconds' }, { key: 'B', text: '10 seconds' }, { key: 'C', text: '20 seconds' }], disabled: false })));
                            }
                        },
                        {
                            key: 'B',
