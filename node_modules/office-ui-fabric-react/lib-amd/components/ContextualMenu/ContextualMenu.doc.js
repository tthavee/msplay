define(["require", "exports", "react", "./ContextualMenu.checklist", "./examples/ContextualMenu.Basic.Example", "./examples/ContextualMenu.Icon.Example", "./examples/ContextualMenu.Icon.SecondaryText.Example", "./examples/ContextualMenu.Submenu.Example", "./examples/ContextualMenu.Section.Example", "./examples/ContextualMenu.Checkmarks.Example", "./examples/ContextualMenu.Directional.Example", "./examples/ContextualMenu.Customization.Example", "./examples/ContextualMenu.CustomizationWithNoWrap.Example", "./examples/ContextualMenu.ScrollBar.Example", "./examples/ContextualMenu.CustomMenuItem.Example", "./examples/ContextualMenu.CustomMenuList.Example"], function (require, exports, React, ContextualMenu_checklist_1, ContextualMenu_Basic_Example_1, ContextualMenu_Icon_Example_1, ContextualMenu_Icon_SecondaryText_Example_1, ContextualMenu_Submenu_Example_1, ContextualMenu_Section_Example_1, ContextualMenu_Checkmarks_Example_1, ContextualMenu_Directional_Example_1, ContextualMenu_Customization_Example_1, ContextualMenu_CustomizationWithNoWrap_Example_1, ContextualMenu_ScrollBar_Example_1, ContextualMenu_CustomMenuItem_Example_1, ContextualMenu_CustomMenuList_Example_1) {
    "use strict";
