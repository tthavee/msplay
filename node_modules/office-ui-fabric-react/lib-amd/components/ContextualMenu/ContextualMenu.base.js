    ...
    var ContextualMenuBase = /** @class */ (function (_super) {
        ...
        function ContextualMenuBase(props) {
            ...
            _this._shouldHandleKeyDown = function (ev) {
                return ev.which === Utilities_1.KeyCodes.escape || _this._shouldCloseSubMenu(ev) || (ev.which === Utilities_1.KeyCodes.up && (ev.altKey || ev.metaKey));
            };
        ...
        ContextualMenuBase.prototype.render = function () {
            ...
            if (items && items.length > 0) {
                ...
                var calloutStyles = !getMenuClassNames && this._classNames.subComponentStyles
                    ...
                    : undefined;
                return (React.createElement(Callout_1.Callout, tslib_1.__assign({ styles: calloutStyles }, calloutProps, { target: target, isBeakVisible: isBeakVisible, beakWidth: beakWidth, directionalHint: directionalHint, directionalHintForRTL: directionalHintForRTL, gapSpace: gapSpace, coverTarget: coverTarget, doNotLayer: doNotLayer, className: Utilities_1.css('ms-ContextualMenu-Callout', calloutProps ? calloutProps.className : undefined), setInitialFocus: shouldFocusOnMount, onDismiss: this.props.onDismiss, onScroll: this._onScroll, bounds: bounds, directionalHintFixed: directionalHintFixed, alignTargetEdge: alignTargetEdge, hidden: this.props.hidden }),
