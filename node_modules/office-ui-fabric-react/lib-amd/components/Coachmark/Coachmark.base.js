define(["require", "exports", "tslib", "react", "../../Utilities", "../../Styling", "../../utilities/positioning", "./PositioningContainer/index", "./Beak/Beak", "../../common/DirectionalHint", "./Coachmark.styles", "../../FocusTrapZone"], function (require, exports, tslib_1, React, Utilities_1, Styling_1, positioning_1, index_1, Beak_1, DirectionalHint_1, Coachmark_styles_1, FocusTrapZone_1) {
    "use strict";
                    ...
                    React.createElement("div", { className: classNames.translateAnimationContainer, ref: this._translateAnimationContainer },
                        React.createElement("div", { className: classNames.scaleAnimationLayer },
                            React.createElement("div", { className: classNames.rotateAnimationLayer },
                                this._positioningContainer.current && isCollapsed && (React.createElement(Beak_1.Beak, { left: beakLeft, top: beakTop, right: beakRight, bottom: beakBottom, direction: this._beakDirection, color: color })),
