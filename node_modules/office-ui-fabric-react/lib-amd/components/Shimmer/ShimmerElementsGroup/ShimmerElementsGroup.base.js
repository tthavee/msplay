                ...
                var renderedElements = shimmerElements ? (shimmerElements.map(function (elem, index) {
                    ...
                    switch (elem.type) {
                        case Shimmer_types_1.ShimmerElementType.circle:
                            return React.createElement(ShimmerCircle_1.ShimmerCircle, tslib_1.__assign({ key: index }, filteredElem, { styles: _this._getBorderStyles(elem, rowHeight) }));
                        case Shimmer_types_1.ShimmerElementType.gap:
                            return React.createElement(ShimmerGap_1.ShimmerGap, tslib_1.__assign({ key: index }, filteredElem, { styles: _this._getBorderStyles(elem, rowHeight) }));
                        case Shimmer_types_1.ShimmerElementType.line:
                            return React.createElement(ShimmerLine_1.ShimmerLine, tslib_1.__assign({ key: index }, filteredElem, { styles: _this._getBorderStyles(elem, rowHeight) }));
                    }
