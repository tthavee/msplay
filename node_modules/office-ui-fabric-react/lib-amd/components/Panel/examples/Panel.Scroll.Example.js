    ...
    var PanelScrollExample = /** @class */ (function (_super) {
        ...
        PanelScrollExample.prototype.render = function () {
            return (React.createElement("div", null,
                ...
                React.createElement(Panel_1.Panel, { isOpen: this.state.showPanel, type: Panel_1.PanelType.smallFixedFar, onDismiss: this._onClosePanel, isFooterAtBottom: true, headerText: "Panel with scrolling content", closeButtonAriaLabel: "Close", onRenderFooterContent: this._onRenderFooterContent },
