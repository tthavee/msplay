define(["require", "exports", "tslib", "react", "../../Utilities", "../../FocusZone", "./Calendar.scss", "../../Icon"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, stylesImport, Icon_1) {
    ...
    var CalendarYearGridCell = /** @class */ (function (_super) {
        ...
        function CalendarYearGridCell() {
            ...
            _this._onButtonRef = function (ref) {
                _this._buttonRef = ref;
            };
        ...
        CalendarYearGridCell.prototype.render = function () {
            ...
            return (React.createElement("button", { className: Utilities_1.css('ms-DatePicker-yearOption', styles.yearOption, (_b = {},
                    ...
                    _b)), type: "button", role: "gridcell", onClick: !disabled && onSelectYear ? this._onClick : undefined, onKeyDown: !disabled && onSelectYear ? this._onKeyDown : undefined, disabled: disabled, "aria-label": String(year), "aria-selected": selected, ref: this._onButtonRef }, this._onRenderYear()));
            var _b;
        };
    ...
    var CalendarYearGrid = /** @class */ (function (_super) {
        ...
        function CalendarYearGrid() {
            ...
            _this._renderCell = function (year) {
                ...
                return (React.createElement(CalendarYearGridCell, { key: year, year: year, selected: selected, current: current, disabled: disabled, onSelectYear: onSelectYear, ref: selected ? _this._onSelectedCellRef : current ? _this._onCurrentCellRef : undefined }));
            };
            _this._onSelectedCellRef = function (ref) {
                _this._selectedCellRef = ref;
            };
            _this._onCurrentCellRef = function (ref) {
                _this._currentCellRef = ref;
            };
            return _this;
        }
        ...
        CalendarYearTitle.prototype.render = function () {
            ...
            if (onHeaderSelect) {
                ...
                var ariaLabel = rangeAriaLabel
                    ...
                    : undefined;
                return (React.createElement("div", { className: Utilities_1.css('ms-DatePicker-currentDecade js-showYearPicker', styles.currentDecade, styles.headerToggleView), onClick: this._onHeaderSelect, onKeyDown: this._onHeaderKeyDown, "aria-label": ariaLabel, role: "button", tabIndex: 0 },
    ...
    var CalendarYear = /** @class */ (function (_super) {
        ...
        function CalendarYear(props) {
            ...
            _this._renderGrid = function () {
                return (React.createElement(CalendarYearGrid, tslib_1.__assign({}, _this.props, { fromYear: _this.state.fromYear, toYear: _this.state.fromYear + CELL_COUNT - 1, ref: _this._onGridRef })));
            };
            _this._onGridRef = function (ref) {
                _this._gridRef = ref;
            };
            _this.state = _this._getState(_this.props);
            return _this;
        }
        CalendarYear.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        CalendarYear.prototype._getState = function (props) {
