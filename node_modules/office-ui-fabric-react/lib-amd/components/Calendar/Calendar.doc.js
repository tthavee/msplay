    ...
    exports.CalendarPageProps = {
        ...
        examples: [
            ...
            },
            {
                ...
                code: CalendarInlineExampleCode,
                view: (React.createElement(Calendar_Inline_Example_1.CalendarInlineExample, { dateRangeType: Calendar_1.DateRangeType.Week, autoNavigateOnSelection: true, highlightCurrentMonth: false, highlightSelectedMonth: true, showGoToToday: true, showNavigateButtons: true, minDate: DateMath_1.addWeeks(today, -2), maxDate: DateMath_1.addWeeks(today, 2) }))
            },
            {
