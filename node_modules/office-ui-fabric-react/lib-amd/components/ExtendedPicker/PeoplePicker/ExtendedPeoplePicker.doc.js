define(["require", "exports", "react", "../examples/ExtendedPeoplePicker.Basic.Example"], function (require, exports, React, ExtendedPeoplePicker_Basic_Example_1) {
    "use strict";
    ...
    exports.ExtendedPeoplePickerPageProps = {
        ...
        componentUrl: 'https://github.com/OfficeDev/office-ui-fabric-react/tree/master/packages/office-ui-fabric-react/src/components/ExtendedPeoplePicker',
        examples: [
            {
                title: 'Extended People Picker',
                code: ExtendedPeoplePickerBasicExampleCode,
                view: React.createElement(ExtendedPeoplePicker_Basic_Example_1.ExtendedPeoplePickerTypesExample, null)
            }
        ],
