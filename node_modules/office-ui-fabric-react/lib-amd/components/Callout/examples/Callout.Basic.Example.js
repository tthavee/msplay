define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/Button", "office-ui-fabric-react/lib/Callout", "office-ui-fabric-react/lib/Link", "office-ui-fabric-react/lib/Styling"], function (require, exports, tslib_1, React, Button_1, Callout_1, Link_1, Styling_1) {
    "use strict";
    ...
    var CalloutBasicExample = /** @class */ (function (_super) {
        ...
        CalloutBasicExample.prototype.render = function () {
            ...
            return (React.createElement("div", null,
                ...
                React.createElement(Callout_1.Callout, { className: "ms-CalloutExample-callout", ariaLabelledBy: 'callout-label-1', ariaDescribedBy: 'callout-description-1', role: 'alertdialog', gapSpace: 0, target: this._menuButtonElement.current, onDismiss: this._onCalloutDismiss, setInitialFocus: true, hidden: !this.state.isCalloutVisible },
