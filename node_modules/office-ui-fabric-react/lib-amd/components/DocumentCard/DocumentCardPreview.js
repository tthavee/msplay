define(["require", "exports", "tslib", "react", "../../Image", "../../Icon", "../../Link", "../../Utilities", "./DocumentCard.scss"], function (require, exports, tslib_1, React, Image_1, Icon_1, Link_1, Utilities_1, stylesImport) {
    "use strict";
        ...
        function DocumentCardPreview() {
            ...
            _this._renderPreviewList = function (previewImages) {
                ...
                var fileListItems = previewImages.slice(0, LIST_ITEM_COUNT).map(function (file, fileIndex) { return (React.createElement("li", { key: fileIndex },
                    ...
                    React.createElement(Link_1.Link, tslib_1.__assign({}, (file.linkProps, { href: file.url || (file.linkProps && file.linkProps.href) })), file.name))); });
