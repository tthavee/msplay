...
var ChoiceGroupBase = /** @class */ (function (_super) {
    ...
    ChoiceGroupBase.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, theme = _a.theme, styles = _a.styles, options = _a.options, label = _a.label, required = _a.required, disabled = _a.disabled, name = _a.name, _b = _a.role, role = _b === void 0 ? 'application' : _b;
        ...
        React.createElement("div", { role: role, className: classNames.applicationRole },
