...
export var CalendarPageProps = {
    ...
    examples: [
        ...
        },
        {
            ...
            code: CalendarInlineExampleCode,
            view: (React.createElement(CalendarInlineExample, { dateRangeType: DateRangeType.Week, autoNavigateOnSelection: true, highlightCurrentMonth: false, highlightSelectedMonth: true, showGoToToday: true, showNavigateButtons: true, minDate: addWeeks(today, -2), maxDate: addWeeks(today, 2) }))
        },
        {
