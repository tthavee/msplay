...
var DetailsListNavigatingFocusExample = /** @class */ (function (_super) {
    ...
    DetailsListNavigatingFocusExample.prototype.render = function () {
        return (React.createElement(DetailsList, { items: this.state.items, columns: this._columns, initialFocusedIndex: this.state.initialFocusedIndex, ariaLabelForSelectionColumn: "Toggle selection", ariaLabelForSelectAllCheckbox: "Toggle selection for all items" }));
    };
