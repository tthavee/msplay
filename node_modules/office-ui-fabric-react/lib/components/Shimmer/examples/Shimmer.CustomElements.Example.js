    ...
    function ShimmerCustomElementsExample(props) {
        ...
        _this._getCustomElementsExampleOne = function () {
            return (React.createElement("div", { 
                ...
                style: { display: 'flex' } },
                React.createElement(ShimmerElementsGroup, { shimmerElements: [{ type: ElemType.line, width: 40, height: 40 }, { type: ElemType.gap, width: 10, height: 40 }] }),
        ...
        _this._getCustomElementsExampleThree = function () {
            return (React.createElement("div", { 
                // tslint:disable-next-line:jsx-ban-props
                style: { display: 'flex' } },
                React.createElement(ShimmerElementsGroup, { width: '90px', shimmerElements: [{ type: ElemType.line, height: 80, width: 80 }, { type: ElemType.gap, width: 10, height: 80 }] }),
