...
var ModalBasicExample = /** @class */ (function (_super) {
    ...
    ModalBasicExample.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Modal, { titleAriaId: "titleId", subtitleAriaId: "subtitleId", isOpen: this.state.showModal, onDismiss: this._closeModal, isBlocking: false, containerClassName: "ms-modalExample-container" },
                ...
                React.createElement("div", { id: "subtitleId", className: "ms-modalExample-body" },
                    React.createElement(DefaultButton, { onClick: this._closeModal, text: "Close" }),
