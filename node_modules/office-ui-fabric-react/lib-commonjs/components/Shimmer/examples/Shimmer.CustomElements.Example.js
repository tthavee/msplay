    ...
    function ShimmerCustomElementsExample(props) {
        ...
        _this._getCustomElementsExampleOne = function () {
            return (React.createElement("div", { 
                ...
                style: { display: 'flex' } },
                React.createElement(Shimmer_1.ShimmerElementsGroup, { shimmerElements: [{ type: Shimmer_1.ShimmerElementType.line, width: 40, height: 40 }, { type: Shimmer_1.ShimmerElementType.gap, width: 10, height: 40 }] }),
        ...
        _this._getCustomElementsExampleThree = function () {
            return (React.createElement("div", { 
                // tslint:disable-next-line:jsx-ban-props
                style: { display: 'flex' } },
                React.createElement(Shimmer_1.ShimmerElementsGroup, { width: '90px', shimmerElements: [{ type: Shimmer_1.ShimmerElementType.line, height: 80, width: 80 }, { type: Shimmer_1.ShimmerElementType.gap, width: 10, height: 80 }] }),
