...
var ComboBoxBasicExample = /** @class */ (function (_super) {
    ...
    function ComboBoxBasicExample(props) {
        ...
        _this._onRenderFontOption = function (item) {
            if (item.itemType === SelectableOption_types_1.SelectableOptionMenuItemType.Header || item.itemType === SelectableOption_types_1.SelectableOptionMenuItemType.Divider) {
