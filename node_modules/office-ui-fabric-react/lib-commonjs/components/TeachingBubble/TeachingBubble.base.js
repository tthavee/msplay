...
var TeachingBubbleBase = /** @class */ (function (_super) {
    ...
    TeachingBubbleBase.prototype.render = function () {
        ...
        var calloutStyles = classNames.subComponentStyles
            ...
            : undefined;
        return (React.createElement(Callout_1.Callout, tslib_1.__assign({ target: targetElement, onDismiss: onDismiss }, calloutProps, { className: classNames.root, styles: calloutStyles, hideOverflow: true }),
