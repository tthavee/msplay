...
var ContextualMenuWithCustomMenuListExample = /** @class */ (function (_super) {
    ...
    ContextualMenuWithCustomMenuListExample.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Button_1.DefaultButton, { id: "ContextualMenuWithCustomMenuListExample", text: "Click for ContextualMenu", menuProps: {
    ...
    ContextualMenuWithCustomMenuListExample.prototype._renderMenuList = function (menuListProps, defaultRender) {
        return (React.createElement("div", null,
            React.createElement("div", { style: { borderBottom: '1px solid #ccc' } },
                React.createElement(SearchBox_1.SearchBox, { ariaLabel: "Filter actions by text", placeholder: "Filter actions", onAbort: this._onAbort, onChange: this._onChange, styles: {
                        root: [{ margin: '8px' }]
                    } })),
